        ...
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-white/20">
            <div className="flex items-baseline justify-between mb-4">
              <h2 className="text-lg font-semibold text-slate-900">Estimated Price</h2>
              <p className="text-4xl font-bold text-green-600">
                £{analysis.estimate.toLocaleString('en-GB', { maximumFractionDigits: 0 })}
              </p>
            </div>
            <p className="text-sm text-slate-600 mb-6">{analysis.description}</p>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button
              ...
              className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition shadow-lg shadow-blue-500/25"
            >
